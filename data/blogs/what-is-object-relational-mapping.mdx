...
<Image src="/images/what-is-object-relational-mapping/cover.png" width={1400} height={750} alt="ORM(Object Relational Mapping)" />
...
class Post(Base):
	...
	caption = Column('password',Text,nullable=False)
